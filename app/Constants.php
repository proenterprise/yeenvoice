...
if (! defined('APP_NAME')) {
    define('APP_NAME', env('APP_NAME', 'Yeenvoice'));
    define('APP_DOMAIN', env('APP_DOMAIN', 'yeenvoice.xyz'));
    ...
    define('CURRENCY_ZAMBIAN_KWACHA', 84);
    define('CURRENCY_EURO', 3);

    define('DEFAULT_TIMEZONE', 'Africa/Harare');
    define('DEFAULT_COUNTRY', 894); // United Stated / ZAMBIA
    define('DEFAULT_CURRENCY', CURRENCY_ZAMBIAN_KWACHA);
    ...
    define('NINJA_ACCOUNT_EMAIL', env('NINJA_ACCOUNT_EMAIL', 'invoice@yeemail.xyz'));
    define('NINJA_LICENSE_ACCOUNT_KEY', 'AsFmBAeLXF0IKf7tmi0eiyZfmWW9hxMT');
    define('NINJA_GATEWAY_ID', GATEWAY_STRIPE);
    define('NINJA_GATEWAY_CONFIG', 'NINJA_GATEWAY_CONFIG');
    define('NINJA_WEB_URL', env('NINJA_WEB_URL', 'https://www.yeenvoice.xyz'));
    define('NINJA_APP_URL', env('NINJA_APP_URL', 'https://demo.yeenvoice.xyz'));
    define('NINJA_DOCS_URL', env('NINJA_DOCS_URL', 'https://docs.yeenvoice.xyz/en/latest'));
    define('NINJA_DATE', '2000-01-01');
    define('NINJA_VERSION', '4.5.13' . env('NINJA_VERSION_SUFFIX'));
    define('NINJA_TERMS_VERSION', '1.0.1');

    define('SOCIAL_LINK_FACEBOOK', env('SOCIAL_LINK_FACEBOOK', 'https://www.facebook.com/goproenterprise'));
    define('SOCIAL_LINK_TWITTER', env('SOCIAL_LINK_TWITTER', 'https://twitter.com'));
    define('SOCIAL_LINK_GITHUB', env('SOCIAL_LINK_GITHUB', 'https://github.com/proenterprise/'));

    define('NINJA_FORUM_URL', env('NINJA_FORUM_URL', 'https://www.yeenvoice.xyz/forums/support/'));
    define('NINJA_CONTACT_URL', env('NINJA_CONTACT_URL', 'https://www.yeenvoice.xyz/contact/'));
    define('NINJA_FROM_EMAIL', env('NINJA_FROM_EMAIL', 'maildelivery@yeemail.xyz'));
    define('NINJA_IOS_APP_URL', '');
    define('NINJA_ANDROID_APP_URL', 'https://play.google.com/store/apps/details?id=com.invoiceninja.flutter2'); //redo
    define('RELEASES_URL', env('RELEASES_URL', 'https://github.com/proenterprise/invoiceninja/releases'));
    ...
    define('REFERRAL_PROGRAM_URL', env('REFERRAL_PROGRAM_URL', 'https://www.yeenvoice.xyz/referral-program/'));
