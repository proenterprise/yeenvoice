...
return [
    ...
    'video_urls' => [
        'all' => env('NINJA_VIDEOS_URL', 'https://www.youtube.com/channel/'),
        'custom_design' => env('NINJA_VIDEOS_CUSTOM_DESIGN_URL', 'https://www.youtube.com/watch?v=ypXQ6jgiHodc'),
        'getting_started' => env('NINJA_VIDEOS_GETTING_STARTED_URL', 'https://www.youtube.com/watch?v=yi7fqfi5HWeo'),
    ],
    ...
    'terms_of_service_url' => [
        'hosted' => env('TERMS_OF_SERVICE_URL', 'https://www.yeenvoice.xyz/terms/'),
        'selfhost' => env('TERMS_OF_SERVICE_URL', 'https://www.yeenvoice.xyz/terms/'),
    ],

    'privacy_policy_url' => [
        'hosted' => env('PRIVACY_POLICY_URL', 'https://www.yeenvoice.xyz/privacy/'),
        'selfhost' => env('PRIVACY_POLICY_URL', 'https://www.yeenvoice.xyz/privacy/'),
    ],
