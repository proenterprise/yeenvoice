...
<html lang="{{App::getLocale()}}">
  ...
  <div class="container">
    ...
    <div class="jumbotron">
        ...
        @endif
        If you need help you can email us at <a href="mailto:yeenvoice@yeemail.xyz" target="_blank">yeenvoice@yeemail.xyz</a>.

        @if (! env('PRECONFIGURED_INSTALL'))
        <p>
<pre>-- Commands to create a MySQL database and user
CREATE SCHEMA `ninja` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
CREATE USER 'yeenvoice'@'localhost' IDENTIFIED BY 'yeenvoice';
GRANT ALL PRIVILEGES ON `ninja`.* TO 'yeenvoice'@'localhost';
