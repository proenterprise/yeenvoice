...
<head>
    ...
    @else
        <title>{{ isset($title) ? ($title . ' | Yeenvoice') : ('Yeenvoice | Simple, Intuitive Invoicing.') }}</title>
        <meta name="description" content="{{ isset($description) ? $description : trans('texts.app_description') }}"/>
        <link href="{{ asset('favicon-v2.png') }}" rel="shortcut icon" type="image/png">

        <meta property="og:site_name" content="Yeenvoice"/>
        <meta property="og:url" content="{{ SITE_URL }}"/>
        <meta property="og:title" content="Yeenvpoice"/>
        ...
        <meta name="apple-mobile-web-app-title" content="Yeenvoice">
        <meta name="application-name" content="Yeenvoice">
